...
contract SupplyChain {
    ...
    function Manufacturing(uint256 _medicineID, uint256 _manufactureDate, uint256 _expiryDate) public {
        require(_medicineID > 0 && _medicineID <= medicineCtr);
        ...
        MedicineStock[_medicineID].manufactureDate = _manufactureDate;
